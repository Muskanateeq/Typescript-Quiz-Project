...
console.log(chalk.bgYellow(`*************Welcome to typescript Quiz!***********`));
let correctanswer = 0;
let questions = 1;
while (questions <= 10) {
    ...
    if (q1.firstQuestion === "a) JavaScript") {
        ...
        console.log(chalk.green("Correct Answer is"), chalk.cyan("a) JavaScript"));
        questions++;
    }
    ...
    if (q2.SecondQuestion === "d) all of the above") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("d) all of the above"));
        questions++;
    }
    ...
    if (q4.ForthQuestion === "c) tsc") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("c) tsc"));
        questions++;
    }
    ...
    if (q5.FifthQuestion === "b. TypeScript adds static typing to JavaScript") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("b. TypeScript adds static typing to JavaScript"));
        questions++;
    }
    ...
    if (q6.SixthQuestion === "a. $") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("a. $"));
        questions++;
    }
    ...
    if (q7.SeventhQuestion === "a. To define types for objects") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("a. To define types for objects"));
        questions++;
    }
    ...
    if (q8.EighthQuestion === "b. class") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("b. class"));
        questions++;
    }
    ...
    if (q9.NinethQuestion === "b. ===") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("b. ==="));
        questions++;
    }
    ...
    if (q10.TenthQuestion === "a. Absence of a value") {
        ...
        console.log(chalk.red(`Wrong Answer!`));
        console.log(chalk.green("Correct Answer is"), chalk.cyan("a. Absence of a value"));
        questions++;
    }
    console.log(chalk.yellow("Dear"), chalk.green(`${name.username}`), chalk.yellow(`Your score is`), chalk.green(`${correctanswer}`), chalk.yellow(`out of 10 Questions`));
}
